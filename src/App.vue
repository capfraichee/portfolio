...
<template>
  <div class="grid grid-cols-12 content-start gap-1 px-25 min-h-screen bg-[var(--background-color-dark)]">
    <header class="ml-2 col-span-12 h-15 align-center flex items-center">
