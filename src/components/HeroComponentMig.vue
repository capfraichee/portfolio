        ...
        <div class="flex flex-row w-[100vw] h-auto relative left-[calc(50%-50vw)]">
                ...
                <div class="w-full mt-20 border-t-[2px] border-black grid grid-cols-12 min-h-[250px]">
                    <p class="pl-5 mt-2 col-span-2" style="font-size: 10px; text-decoration: underline; color: var(--text-color)">Info</p>
                        ...
                        <div class="flex flex-row gap-10 col-start-3 col-end-12 mt-16 mb-16 justify-between items-start">
                            ...
                            <div class="w-full h-full flex justify-between items-center flex-col text-[var(--text-color)] py-2">
                                <p class="text-center">Min LinkedIn</p>
                                <a href="https://www.linkedin.com/in/casper-rasmussen-2a13513b3/" target="" rel="" class="flex items-center justify-center h-10">
                            ...
                            <div class="w-full h-full flex justify-between items-center flex-col text-[var(--text-color)] py-2">
                                ...
                                <a :href="linkedinUrl"
                                download="Casper_Rasmussen_CV.svg"
            ...
            <div class="h-auto flex-1">
                <div class="text-[var(--element-color)] flex flex-row gap-10">
                    <p class="ml-2 mt-1" style="font-size: 10px; text-decoration: underline; color: var(--text-color)">Program: Video CV</p>
                ...
                <div class="w-full h-auto flex flex-col items-center">
                    <h1 class="justify-center flex pt-10 text-[var(--text-color)]" style="font-family: 'Mulish', sans-serif; font-weight: 650; font-size: 36px;">Mit video CV</h1>
                    <iframe 
                        class="w-6/7 block aspect-video"
                        src="https://www.youtube.com/embed/vJ8LX2eXj5U" 
